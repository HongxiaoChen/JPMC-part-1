...
def get_args():
    ...
    parser.add_argument('--input_dim', default=100, type=int, help='dimensionality of input tensor (postion + momentum variables)')
    ...
    parser.add_argument('--len_sample', default=40, type=int, help='length of Hamiltonian trajectory for each training sample')
    parser.add_argument('--dist_name', default='Elliptic', type=str, help='name of the probability distribution function')
    ...
    parser.add_argument('--load_file_name', default='Elliptic', type=str, help='if load training data, the file name (.pkl format)')
    ...
    parser.add_argument('--latent_dim', default=50, type=int, help='latent dimension of mlp')
