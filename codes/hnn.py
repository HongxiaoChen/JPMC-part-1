...
class HNN(tf.keras.Model):
    ...
    def time_derivative(self, x, t=None):
        """
        Compute the time derivatives of the system using Hamilton's equations:
        ...
        # Compute gradients with respect to position and momentum
